...
(function ($) {
  ...
  try {
    ...
    // Recent Report
    const brandProduct = 'rgba(251,211,202,0.8)'

    var elements = 10
    var data = [52, 60, 55, 50, 65, 80, 57, 70, 105, 136, 122, 142]
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            label: "Doanh thu",
            data: [400, 600, 550, 720, 300, 700],
            backgroundColor: 'transparent',
            borderColor: 'rgba(251,211,202,0.75)',
            borderWidth: 3,
            pointStyle: 'circle',
            pointRadius: 5,
            pointBorderColor: 'transparent',
            pointBackgroundColor: 'rgba(251,211,202,0.75)',
          },{
          label: "Lợi nhuận",
          data: [212, 308, 286, 396, 189, 375],
          backgroundColor: 'transparent',
          borderColor: 'rgba(93,92,120,0.75)',
          borderWidth: 3,
          pointStyle: 'circle',
          pointRadius: 5,
          pointBorderColor: 'transparent',
          pointBackgroundColor: 'rgba(93,92,120,0.75)',
        }]
        },
        options: {
          responsive: true,
